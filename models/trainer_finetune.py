...
class FinetuneTrainer(nn.Module):
    ...
    def cal_losses_sdf(self, render_out, sample_rays, iter_step=-1):
        ...
        surf_reg_loss = render_out['surf_reg_loss']
        ...
        losses = {
            ...
            "background_weight": get_weight(iter_step, self.sdf_mask_weight),
            "smooth_weight": get_weight(iter_step, self.sdf_smooth_weight),
